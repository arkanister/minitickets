...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricoTicket.tipo'
        db.add_column(u'minitickets_historicoticket', 'tipo',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricoTicket.tipo'
        db.delete_column(u'minitickets_historicoticket', 'tipo')
