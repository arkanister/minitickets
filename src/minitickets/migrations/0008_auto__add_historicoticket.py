...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricoTicket'
        db.create_table(u'minitickets_historicoticket', (
        ...
        db.send_create_signal(u'minitickets', ['HistoricoTicket'])


    def backwards(self, orm):
        # Deleting model 'HistoricoTicket'
        db.delete_table(u'minitickets_historicoticket')
    ...
    models = {
        ...
        u'minitickets.historicoticket': {
            'Meta': {'object_name': 'HistoricoTicket'},
